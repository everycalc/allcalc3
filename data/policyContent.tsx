...
export const PrivacyPolicyContent = () => (
    <div className="prose prose-sm prose-invert text-theme-secondary max-w-none">
        ...
        <p>
            Welcome to All Type Calculator. We are committed to protecting your privacy. This Privacy Policy explains how we handle information in connection with our web application. Since our application operates entirely on your device, we do not collect, store, or transmit any of your personal data.
        </p>
...
export const TermsOfServiceContent = () => (
    <div className="prose prose-sm prose-invert text-theme-secondary max-w-none">
        ...
        <p>By accessing and using the All Type Calculator web application ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by these terms, please do not use the Service.</p>
