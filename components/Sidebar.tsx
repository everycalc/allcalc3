...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onToggleHistory, onShowSavedDatesPage, onShowOnboarding, onOpenFeedbackModal, onOpenThemeModal }) => {
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full text-theme-primary">
            ...
            <div className="relative flex flex-col flex-grow overflow-y-auto p-4 space-y-2">
                <button 
