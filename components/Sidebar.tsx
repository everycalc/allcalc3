...
const Sidebar: React.FC<SidebarProps> = ({ 
    ...
    onOpenThemeModal, onOpenCheatCodeModal,
    onShowBlogPage
}) => {
      ...
      >
        <div className="flex flex-col h-full text-on-surface">
            ...
            <div className="relative flex flex-col flex-grow overflow-y-auto">
                ...
                <button onClick={handleVersionTap} className="text-center text-xs text-on-surface-variant py-2 hover:bg-surface-container-high w-full">
                    Version {version}
                </button>
            </div>
        </div>
