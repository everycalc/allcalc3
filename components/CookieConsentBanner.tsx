...
const CookieConsentBanner: React.FC<CookieConsentBannerProps> = ({ onShowPrivacyPolicy }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-theme-secondary/90 backdrop-blur-sm p-4 z-50 animate-fade-in-up shadow-lg">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-theme-primary text-center sm:text-left">
        ...
        <button
          ...
          className="bg-primary text-on-primary font-bold py-2 px-6 rounded-md hover:bg-primary-light transition-colors flex-shrink-0"
        >
          Accept
        </button>
      </div>
