    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-center bg-theme-primary p-1 rounded-lg">
                ...
                <button onClick={() => handleModeChange('goalSeek')} className={`w-1/2 py-2 rounded-md transition text-sm ${mode === 'goalSeek' ? 'bg-primary text-on-primary' : 'hover:bg-theme-tertiary'}`}>Plan a Goal (AI)</button>
            </div>
            ...
            {mode === 'calculate' ? (
                ...
                <button onClick={handleGoalSeekCalculate} disabled={isGoalSeeking} className="w-full bg-primary text-on-primary font-bold py-3 px-4 rounded-md hover:bg-primary-light transition-colors duration-200 shadow-lg disabled:bg-theme-tertiary">
