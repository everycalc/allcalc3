...
({ label, unit, value, onChange, name, tooltip }) => (
    <div>
        ...
        <input type="number" id={name} name={name} value={value} onChange={onChange} className="input-base w-full p-2" />
    </div>
);
...
const InventoryManagementCalculator: React.FC<InventoryManagementCalculatorProps> = ({ initialState }) => {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    <div className="bg-surface-container p-4 rounded-lg space-y-4">
                        <button onClick={handleCalculate} className="btn-primary w-full text-lg font-bold py-3 px-4 rounded-md transition-colors duration-200 shadow-lg">
                            Calculate
                        </button>
                        {result && (
                            <div className="space-y-4 mt-4 animate-fade-in">
                                ...
                                <div className="result-card p-4 rounded-lg space-y-3">
                                    ...
                                    <div className="flex justify-between font-bold text-base border-t border-outline-variant pt-2 mt-2"><span>Total Annual Inventory Cost:</span> <span className="text-primary">{formatCurrency(result.totalCost)}</span></div>
                                </div>
