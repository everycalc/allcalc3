...
const ResultBox: React.FC<{ label: string; value: string; subtext?: string; highlight?: boolean }> = ({ label, value, subtext, highlight }) => (
    <div className={`result-card p-4 rounded-lg text-center`}>
        ...
        <p className={`font-bold text-3xl ${highlight ? 'text-primary' : 'text-on-surface'}`}>{value}</p>
...
const CLVCACCalculator: React.FC<CLVCACCalculatorProps> = ({ initialState }) => {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-surface-container p-4 rounded-lg space-y-4">
                    ...
                    <h3 className="font-semibold text-primary pt-4 border-t border-outline-variant">Customer Acquisition Cost (CAC)</h3>
                ...
                <div className="space-y-4">
                    <div className="bg-surface-container p-4 rounded-lg text-center space-y-4">
