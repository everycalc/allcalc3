          ...
          {history.length > 0 && (
            <footer className="p-4 border-t border-theme">
              <div className="flex space-x-2">
                <button onClick={handleExportClick} disabled={selectedIds.size === 0} className="w-1/2 bg-primary text-on-primary font-bold py-2 px-4 rounded-md hover:bg-primary-light transition-colors disabled:bg-theme-tertiary disabled:text-theme-secondary disabled:cursor-not-allowed">
