  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`absolute top-1 left-1 p-1.5 rounded-full text-theme-secondary bg-theme-primary/50 opacity-70 focus:opacity-100 transition-all duration-200 hover:bg-theme-secondary hover:text-primary z-10 ${isPinned ? '!opacity-100 !text-primary' : ''}`}
