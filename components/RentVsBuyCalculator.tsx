        ...
        <div className="space-y-6">
            ...
            {result && (
                <div className="result-card p-6 space-y-4 animate-fade-in">
                    ...
                    <div className={`text-center p-3 mt-4 rounded-lg ${result.totalBuyCost < result.totalRentCost ? 'bg-green-500/20 text-green-400' : 'bg-orange-500/20 text-orange-400'}`}>
